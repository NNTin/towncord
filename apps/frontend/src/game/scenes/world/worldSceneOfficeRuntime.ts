...
export class WorldSceneOfficeRuntime {
  ...
  private officeRegion: TownOfficeRegion | null = null;
  ...
  public bootstrap(): TownOfficeRegion {
    ...
    this.officeRenderable = renderOfficeLayout(this.host.scene, officeRegion.layout, {
      ...
      worldOffsetY: officeRegion.anchorY16 * TOWN_BASE_PX,
  ...
  public getRegion(): TownOfficeRegion | null {
  ...
  private rerenderOffice(): void {
    ...
    this.officeRenderable = renderOfficeLayout(this.host.scene, region.layout, {
      worldOffsetX: region.anchorX16 * TOWN_BASE_PX,
      worldOffsetY: region.anchorY16 * TOWN_BASE_PX,
      tileDepth: RENDER_LAYERS.OFFICE_FLOOR,
