...
// MarchingSquaresKernel implements the 4-corner (16-case) dual-grid variant of marching
// squares, where case bits are packed as nw|ne<<1|se<<2|sw<<3. The kernel is cleanly
// stateless and well-isolated. Limitation: it only supports a binary inside/outside test
// against a single `insideMaterial`. Multi-material blending (e.g. grass-to-sand
// transitions) would require a priority-ordered marching squares pass per material pair,
// or a different tile-matching strategy.
